...
import { Code, Layers, Terminal, Cloud, Database, Settings2 } from "lucide-react";
      ...
      tags.map((tag, i) => {
        ...
        return (
          <SkillTag
            key={tag}
            tag={tag}
            className={isHovered ? "bg-neutral-200 dark:bg-neutral-700" : "bg-neutral-100 dark:bg-neutral-800"}
...
const SKILLS_SECTIONS = [
  { icon: <Code className="w-6 h-6" />, title: "Languages", tags: ["Java", "Python", "JavaScript", "TypeScript", "Scala", "SQL"] },
  { icon: <Layers className="w-6 h-6" />, title: "Frameworks & Libraries", tags: ["Spring Boot", "React", "REST APIs", "Microservices", "Multithreading", "HTML/CSS", "Tailwind CSS"] },
  { icon: <Cloud className="w-6 h-6" />, title: "AWS & Cloud", tags: ["Lambda", "S3", "DynamoDB", "RDS", "ElastiCache/Redis", "ECS", "CDK", "CloudWatch", "Secrets Manager"] },
  { icon: <Database className="w-6 h-6" />, title: "Data & Tools", tags: ["Apache Spark", "PySpark", "MongoDB", "Docker", "Git", "CI/CD Pipelines"] },
  { icon: <Terminal className="w-6 h-6" />, title: "Systems & Architecture", tags: ["Distributed Systems", "API Design", "Caching Strategies", "Pipeline Orchestration", "Performance Optimization"] },
];
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-col items-center w-full">
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
            A snapshot of my technical toolkit — built through 3.8+ years of
            shipping production systems at scale across payments, ads, and grocery domains.
          </p>
        </motion.div>

        <motion.div variants={containerVariants} className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
